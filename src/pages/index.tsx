...
export default function Home() {
  ...
  const [invoiceData, setInvoiceData] = useState<InvoiceData>({
    ...
    offerDeposit: 'X,XXX',
    offerDueDate: 'Month DDth, YYYY',
    offerPendingTitle: 'OFFER PENDING:',
    offerPendingText: 'To confirm your booking, you must pay the full deposit of X,XXX by Month DDth, YYYY and balance before due date listed below, otherwise the booking will be cancelled. Please find full booking terms and conditions listed in your booking description.',
    supplierBookingTitle: 'SUPPLIER BOOKING YYYY',
    bookingDescriptionTitle: 'BOOKING DESCRIPTION',
    descriptionTitle: 'Description',
    depositDueDate: 'Month DDth, YYYY',
    depositAmount: 'X,XXX',
    balanceDueDate: 'Month DDth, YYYY',
